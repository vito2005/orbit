...
export const HELP = [
    ...
    '',
    '🎬 Ссылка на Reels из Instagram или YouTube Shorts на английском — переведу на русский и объясню сленг, ' +
...
export const WELCOME = [
    ...
    '',
    'Присылай голосовое, текст или ссылку на Reels на английском — сохраню мысль или переведу видео.',
    '',
    '/dashboard — открыть журнал, вход прямо здесь.',
    'В профиле можно привязать почту и заходить ещё и по ней.',
].join('\n')

export const START_HINT = 'Присылай голос, текст или ссылку на Reels на английском — сохраню в журнал или переведу.'

export const LINKED = '✅ Аккаунт привязан. Присылай голос, текст или ссылку на Reels на английском.'
...
export const PROFILE_DESCRIPTION =
    ...
    'Кидай ссылку на Reels на английском — переведу и объясню шутки.'

// Shown on the bot's profile and when it is shared (120 chars max).
export const PROFILE_SHORT_DESCRIPTION = 'Голосовой журнал мыслей и переводчик Reels'
